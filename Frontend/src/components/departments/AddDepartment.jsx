...
const AddDepartment = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try{
        const response = await axios.post('https://e-ms-ut2u.onrender.com/api/department/add',department,{
          headers : {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        onChange={handleChange}
                        className="mt-1 block w-full p-2 border border-gray-300 rounded-md"></textarea>
